...
## **7\. Laman Web Interaktif (JavaScript)**

* **Definisi:** Laman web interaktif membenarkan pengguna berinteraksi dengan kandungan, seperti mengisi borang atau menekan butang.  
* **Fungsi JavaScript:** Bahasa penskripan klien yang memproses permintaan pengguna, seperti pengesahan data (*data validation*).  
* **Contoh Penggunaan:**  
  * Menyemak jika pengguna membiarkan ruang nama kosong sebelum menghantar borang.  
  * Memaparkan kotak amaran (*popup alert*) seperti "Sila masukkan nama anda" jika data tidak lengkap.
