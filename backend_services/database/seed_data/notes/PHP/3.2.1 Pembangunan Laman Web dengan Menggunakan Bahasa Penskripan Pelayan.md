...
# Latihan
```quiz
{ "question": "1. Dalam model Pelanggan/Pelayan (Client-Server), manakah antara berikut bertindak sebagai \"Pelanggan\" dalam konteks melayari internet?", "options": [ "Pangkalan Data", "Pelayar Web (Web Browser)", "Pembekal Perkhidmatan Internet (ISP)", "Penghala (Router)" ], "correctIndex": 1 } 
```
```quiz
{ "question": "2. Apakah kelebihan utama bahasa penskripan pelayan berbanding bahasa penskripan klien?", "options": [ "Ia boleh mencantikkan rupa bentuk laman web dengan animasi.", "Ia tidak bergantung kepada jenis pelayar web pengguna kerana kod diproses sepenuhnya di pelayan.", "Ia membolehkan pengguna mengubah kod sumber laman web secara terus.", "Ia tidak memerlukan sambungan internet untuk berfungsi." ], "correctIndex": 1 }
```
```quiz
{ "question": "3. Berdasarkan nota anda, manakah antara berikut merupakan fungsi utama penskripan pelayan dalam sebuah aplikasi web dinamik?", "options": [ "Menentukan jenis tulisan (font) yang digunakan di laman web.", "Melaksanakan animasi pada butang apabila diklik.", "Mengakses dan memproses data daripada pangkalan data.", "Mengubah warna latar belakang laman web secara automatik." ], "correctIndex": 2 }
```
```quiz
{ "question": "4. Bahasa pengaturcaraan manakah yang sering digunakan sebagai tulang belakang dalam analisis bioinformatik dan Projek Genom Manusia?", "options": [ "PHP", "ASP", "Python", "Perl" ], "correctIndex": 3 }
```
```quiz
{ "question": "5. Mengapakah laman web yang berkualiti tinggi disarankan menggunakan gabungan penskripan klien DAN penskripan pelayan?", "options": [ "Untuk membolehkan laman web dibuka tanpa menggunakan pelayan.", "Untuk meningkatkan tahap keselamatan, terutamanya dalam proses pengesahan data.", "Untuk memastikan laman web hanya boleh dibuka oleh satu jenis pelayar sahaja.", "Untuk mengelakkan penggunaan pangkalan data yang rumit." ], "correctIndex": 1 }
```