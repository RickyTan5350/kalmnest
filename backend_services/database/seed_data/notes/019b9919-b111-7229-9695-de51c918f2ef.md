...
```quiz
{
  "question": "1. Apakah tujuan utama melakukan pengesahsahihan (validation) pada data input pengguna sebelum disimpan ke dalam pangkalan data?",
  "options": [
    "Untuk mencantikkan rupa bentuk borang pendaftaran.",
    "Untuk mengelakkan ralat semasa proses penyimpanan data dan memastikan data adalah sah.",
    "Untuk memastikan laman web boleh dibuka tanpa sambungan internet.",
    "Untuk menukar warna tulisan dalam pangkalan data kepada warna merah."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "2. Di dalam kod PHP, fungsi manakah yang digunakan secara khusus untuk menyemak sama ada sesuatu medan input itu dibiarkan kosong oleh pengguna?",
  "options": [
    "filter_var()",
    "htmlspecialchars()",
    "empty()",
...
```quiz
{
  "question": "3. Seorang pengatur cara ingin memastikan alamat e-mel yang dimasukkan oleh pengguna mematuhi format yang sah (contoh: user@mail.com). Apakah fungsi PHP yang paling sesuai digunakan?",
  "options": [
...
```quiz
{
  "question": "4. Apakah peranan fungsi htmlspecialchars() dalam pengurusan input pengguna?",
  "options": [
    "Mengira bilangan aksara dalam sesuatu medan teks.",
    "Menukar abjad khas kepada entiti HTML untuk mengelakkan serangan keselamatan seperti code injection.",
    "Menghantar data borang terus ke alamat e-mel pentadbir.",
    "Menghapuskan semua mesej ralat yang berwarna merah pada skrin."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "5. Berdasarkan nota, bagaimanakah sistem mengenali bahawa pengguna telah menekan butang 'Daftar' dan menghantar borang ke pelayan?",
  "options": [
    "Apabila pemboleh ubah $errName menjadi merah.",
    "Melalui semakan syarat if ($_SERVER[\"REQUEST_METHOD\"] == \"POST\").",
    "Apabila fungsi htmlspecialchars() dijalankan secara automatik.",
    "Melalui penggunaan kod CSS .error {color: #FF0000;}."
  ],
  "correctIndex": 1
}
