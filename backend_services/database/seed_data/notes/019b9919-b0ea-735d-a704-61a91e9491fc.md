...
```quiz
{
  "question": "1. Apakah peranan utama atribut onclick di dalam tag <button>?",
  "options": [
    "Menetapkan warna butang tersebut.",
    "Menyambungkan butang ke pangkalan data secara terus.",
    "Mencetuskan atau melaksanakan kod JavaScript apabila pengguna menekan butang tersebut.",
    "Menghantar borang ke pelayan (server) secara automatik."
  ],
  "correctIndex": 2
}
...
```quiz
{
  "question": "2. Di dalam sebuah borang HTML (<form>), elemen manakah yang digunakan secara khusus untuk menghantar data ke halaman lain?",
  "options": [
    "<input type=\"text\">",
    "<input type=\"submit\">",
    "<input type=\"radio\">",
...
```quiz
{
  "question": "3. Manakah antara berikut merupakan ciri-ciri laman web interaktif?",
  "options": [
    "Hanya memaparkan teks dan imej statik tanpa sebarang tindak balas.",
    "Menggunakan HTML/CSS sahaja tanpa bantuan JavaScript.",
    "Membolehkan komunikasi dua hala antara pengguna dan sistem melalui input dan respon segera.",
    "Laman web yang tidak boleh dibuka menggunakan pelayar web (browser)."
  ],
  "correctIndex": 2
}
...
```quiz
{
  "question": "4. Berdasarkan kod contoh \"Isihan Buih\" dalam nota anda, apakah kesan penggunaan document.write(no) di dalam fungsi selepasIsih()?",
  "options": [
    "Ia akan menambah butang baharu pada skrin.",
    "Ia akan memaparkan tatasusunan yang telah disusun semula ke atas skrin pelayar.",
    "Ia akan memadamkan kod JavaScript yang sedia ada.",
    "Ia akan meminta pengguna memasukkan nombor baharu."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "5. Mengapakah pembinaan fungsi (function) seperti tukarKedudukan() dianggap amalan pengaturcaraan yang baik dalam membina aplikasi interaktif?",
  "options": [
    "Kerana ia membolehkan logik pertukaran data dipanggil berulang kali tanpa perlu menulis semula kod yang sama.",
    "Kerana ia menjadikan fail HTML lebih besar dan berat.",
    "Kerana ia menghalang pengguna daripada menekan butang hantar.",
    "Kerana fungsi tersebut hanya boleh digunakan sekali sahaja dalam satu atur cara."
  ],
  "correctIndex": 0
}
