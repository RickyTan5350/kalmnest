...
```quiz
{
  "question": "1. Antara situasi berikut, manakah yang paling tepat menggambarkan penggunaan Struktur Kawalan Jujukan?",
  "options": [
    "Memaparkan mesej \"Lulus\" jika markah lebih daripada 40.",
    "Mengira luas segiempat dengan mendarab panjang dan lebar, kemudian memaparkan hasilnya.",
    "Mengulang paparan nama murid sebanyak 10 kali menggunakan pembilang.",
    "Meminta pengguna memasukkan kata laluan sehingga jawapan yang betul diberikan."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "2. Apakah perbezaan utama antara struktur while dan do...while?",
  "options": [
    "while menggunakan pembilang, manakala do...while menggunakan ungkapan logik.",
    "while menyemak syarat selepas kod dilaksanakan, manakala do...while menyemak syarat sebelum kod dilaksanakan.",
    "do...while akan melaksanakan kod sekurang-kurangnya sekali walaupun syarat adalah palsu, manakala while tidak.",
    "while hanya boleh digunakan dalam HTML, manakala do...while hanya dalam JavaScript."
  ],
  "correctIndex": 2
}
...
```quiz
{
  "question": "3. Diberi satu blok kod JavaScript: if (umur >= 18 && warganegara == \"Malaysia\"). Apakah maksud operator && dalam pernyataan tersebut?",
  "options": [
    "Kod akan dilaksanakan jika salah satu syarat (umur atau warganegara) adalah benar.",
    "Kod akan dilaksanakan hanya jika kedua-dua syarat umur dan warganegara adalah benar.",
    "Kod akan dilaksanakan jika umur tidak sama dengan 18.",
    "Kod akan dilaksanakan secara berulang sebanyak 18 kali."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "4. Apakah fungsi arahan break di dalam satu struktur ulangan for?",
  "options": [
    "Melangkau lelaran (pusingan) semasa dan pergi ke pusingan seterusnya.",
    "Memberhentikan keseluruhan proses ulangan serta-merta apabila syarat tertentu dipenuhi.",
    "Menambah nilai pembilang secara automatik.",
    "Memulakan semula ulangan dari nilai awal."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "5. Berdasarkan nota anda tentang do...while (syarat tidak dipenuhi), apakah hasil paparan jika nilai awal ulang = 4 dan syaratnya ialah while(ulang <= 3)?",
  "options": [
    "Tiada sebarang paparan dihasilkan.",
    "Paparan \"Salam Sejahtera!\" sebanyak 3 kali.",
    "Paparan \"Salam Sejahtera!\" sebanyak 1 kali.",
    "Ralat (error) akan dipaparkan pada pelayar web."
  ],
  "correctIndex": 2
}
