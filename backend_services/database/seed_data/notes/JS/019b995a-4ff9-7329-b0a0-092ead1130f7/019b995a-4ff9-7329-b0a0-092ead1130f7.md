...
```quiz
{
  "question": "1. Jika tatasusunan diisytiharkan sebagai var markah = [70, 85, 92, 60];, apakah nilai bagi markah[2]?",
  "options": [
    "70",
    "85",
    "92",
...
```quiz
{
  "question": "2. Mengapakah gelung for sering digunakan bersama-sama dengan tatasusunan?",
  "options": [
    "Untuk memadamkan keseluruhan tatasusunan daripada memori.",
    "Untuk membolehkan setiap unsur dalam tatasusunan dicapai dan diproses secara automatik satu demi satu.",
    "Untuk menukarkan tatasusunan menjadi pemalar (constant).",
    "Kerana tatasusunan tidak boleh berfungsi tanpa arahan for."
  ],
  "correctIndex": 1
}
...
```quiz
{
  "question": "3. Di dalam kod algoritma Isihan Buih (Bubble Sort), apakah kegunaan utama pemboleh ubah sementara?",
  "options": [
    "Menyimpan jumlah keseluruhan nilai dalam tatasusunan.",
    "Bertindak sebagai pembilang pusingan gelung.",
    "Menyimpan nilai sesuatu unsur buat seketika semasa proses pertukaran kedudukan (swap) berlaku.",
    "Menentukan saiz atau panjang tatasusunan."
  ],
  "correctIndex": 2
}
...
```quiz
{
  "question": "4. Diberi tatasusunan var no = [10, 20, 30];. Manakah antara pernyataan berikut akan menghasilkan jumlah 60?",
  "options": [
    "jumlah = no[1] + no[2] + no[3];",
    "jumlah = no[0] + no[1] + no[2];",
    "jumlah = no.sum();",
    "jumlah = no[0] + no[3];"
  ],
  "correctIndex": 1
...
```quiz
{
  "question": "5. Apakah yang akan berlaku sekiranya syarat if (no[j] > no[j+1]) dalam algoritma isihan ditukar kepada if (no[j] < no[j+1])?",
  "options": [
    "Atur cara akan mengalami ralat (error).",
    "Senarai akan diisih secara menurun (besar ke kecil).",
    "Senarai akan diisih secara menaik (kecil ke besar).",
    "Kedudukan nombor tidak akan berubah langsung."
  ],
  "correctIndex": 1
}
