                          ...
                          : () async {
                              ...
                              for (final type in levelTypes) {
                                ...
                                if (kDebugMode) {
                                  ...
                                  print(
                                    '[EDIT_GAME_PAGE] Data: ${localLevel ?? originalLevelData[type]?.toString() ?? "null"}',
                                  );
                                  print('[EDIT_GAME_PAGE] Loading win data');
                                  print(
                                    '[EDIT_GAME_PAGE] Data: ${localWin ?? originalWinData[type]?.toString() ?? "null"}',
                                  );
                                }
                          ...
                          controller.addJavaScriptHandler(
                            ...
                            callback: (args) async {
                              ...
                              if (args.length >= 4) {
                                ...
                                if (kDebugMode) {
                                  final normalizedDataType =
                                      dataType.toLowerCase().contains('win')
                                      ? 'win'
                                      : 'level';
                                  print(
                                    '[EDIT_GAME_PAGE] Saving $normalizedDataType data',
                                  );
