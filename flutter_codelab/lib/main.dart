...
void main() async {
  WidgetsFlutterBinding.ensureInitialized();
    ...
    final String? storedToken = await AuthApi.getToken();

    // Attach token to initial UserDetails so pages that read `currentUser.token`
    // (e.g., Feedback) will include Authorization header.
